...
RUN apt-get install -y libzmq3-dev libzmq3 libzmqpp-dev libzmqpp3 libpng12-dev
RUN apt-get install -y hdf5-helpers libhdf5-8 libhdf5-cpp-8 libhdf5-dev python-h5py
